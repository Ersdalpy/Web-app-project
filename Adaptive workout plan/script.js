...
function handleWorkoutSelection(event) {
    const selectedWorkout = event.currentTarget;
...
function handleIntensitySelection(event) {
    var _a, _b;
    ...
    const workoutType = (_a = document.querySelector('.selected h2')) === null || _a === void 0 ? void 0 : _a.textContent;
    const intensity = (_b = target.querySelector('h2')) === null || _b === void 0 ? void 0 : _b.textContent;
